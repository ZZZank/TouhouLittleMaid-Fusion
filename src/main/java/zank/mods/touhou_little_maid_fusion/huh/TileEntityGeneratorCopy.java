...
public abstract class TileEntityGeneratorCopy extends TileEntityMekanism {
    ...
    public TileEntityGeneratorCopy(Holder<Block> blockProvider, BlockPos pos, BlockState state, @NotNull LongSupplier maxOutput) {
    ...
    /// Do you know that in original TileEntityGenerator, this method is PACKAGE PRIVATE, WHY
    /// @see mekanism.generators.common.tile.TileEntityGenerator
