...
interface FusionRenderImpl {
    ...
    static void render(
        ...
        renderPart(core, poseStack, buffer, EnumColor.RED, scale1, ticks, -6, -7, 0, 36);

        // Layer 2: PINK - oscillating scale, Y rotation 4°/tick, coreVec rotation 36°/tick
        float scale2 = 1.0F + 0.8F * sinDegrees(3L * scaledTemp);
        renderPart(core, poseStack, buffer, EnumColor.PINK, scale2, ticks, 4, 4, 0, 36);
        ...
        renderPart(core, poseStack, buffer, EnumColor.ORANGE, scale3, ticks, 5, -3, -35, 106);
